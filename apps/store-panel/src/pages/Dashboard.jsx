  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500">Resumo rápido do painel da loja.</p>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Link do Cardápio Digital</h3>
            <p className="text-sm text-slate-500">
              Compartilhe o acesso público para os clientes finalizarem pedidos.
            </p>
          </div>
          {store?.isActive ? (
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Últimos pedidos</h3>
            <p className="text-sm text-slate-500">Acompanhe os pedidos mais recentes.</p>
          </div>
        </div>
        {loading ? (
          <p className="mt-4 text-sm text-slate-500">Carregando pedidos...</p>
        ) : latestOrders.length === 0 ? (
          <p className="mt-4 text-sm text-slate-500">Nenhum pedido registrado ainda.</p>
        ) : (
          <div className="mt-4 space-y-3">
            {latestOrders.map((order) => (
              ...
              >
                <div>
                  <p className="text-sm font-semibold text-slate-900">Pedido #{order.shortId}</p>
