          ...
          <section className="space-y-6">
            {isMenuV2 ? (
              ...
              >
                <div
                  ref={categoriesRef}
                  className="max-w-full overflow-x-auto overscroll-x-contain whitespace-nowrap px-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
                >
                  ...
                  {sortedCategories.map((category) => (
                    <button
                      ...
                      className={`whitespace-nowrap rounded-full border px-3 py-2 text-xs font-semibold transition-colors duration-150 ease-out motion-reduce:transition-none sm:px-4 ${
            ...
            {sortedCategories.map((category) => (
              <div
                ...
                className={`space-y-3 ${isMenuV2 ? "scroll-mt-24 sm:scroll-mt-[140px]" : ""}`}
              >
                <h2
                  id={`cat-${category.id}`}
                  ref={(node) => {
